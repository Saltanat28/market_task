    ...
    public static void main(String[] args) {
        ...
        while (true){
            ...
            switch (num) {
                ...
                case 8 -> System.out.println(service.getRegion());
                case 9 -> System.out.println(service.getBank());
                case 10 -> service.sortByPrice();
                case 11 -> service.getAllProducts();
                case 12 -> service.getProductMarket();
                case 13 -> service.creatMarket();
                case 14 -> service.getAllMarket();
            }
        }
    }
}